    ...
    <div class="filter-container cus-bg-fa">
      ...
      <div class="filter-box cus-d-fl">
        <el-form :inline="true" class="cus-fl-1 cus-text-right">
          <el-form-item>
            <el-input v-model="listQuery.name" placeholder="普通模糊搜索:标题" suffix-icon="el-icon-search"></el-input>
          </el-form-item>
        </el-form>
        <div class="btn-box">
        ...
        <div class="height-level-box cus-pa-tb-10" v-show="isHeightLevel">
          <el-form :inline="true" label-width="90px" class="demo-form-inline clearfix">
            ...
            <el-form-item label="事项类型:">
              <el-select v-model="listQuery.mattertype" placeholder="请选择">
                <el-option
                  v-for="item in mattertypeOptions"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
    ...
    <div class="result-box">
      <div class="btn-box cus-mb-10">
        <el-button
          ...
          @click="$router.push('/generalInfo/addGuide')"
        >新增</el-button>
      ...
      <el-table :data="tableData" border class="cus-mb-20">
        ...
        <el-table-column prop="pic" label="封面图" width="100px"></el-table-column>
        <el-table-column prop="type" label="办事类型"></el-table-column>
        ...
        <el-table-column prop="startStatu" label="启动状态" width="100px"></el-table-column>
