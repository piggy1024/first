      ...
      <div class="result-box">
        <div class="btn-box cus-mb-10">
          <el-button
            ...
            @click="$router.push('/medicalSocialSecurity/addOldPension')"
          >新增</el-button>
        ...
        <el-table :data="tableData" border class="cus-mb-20">
          ...
          <el-table-column prop="id" label width="55px"></el-table-column>
          ...
          <el-table-column prop="account" label="社保账号" width="130px"></el-table-column>
          <el-table-column prop="money" label="领取金额"></el-table-column>
          <el-table-column prop="date" label="领取日期" width="130px"></el-table-column>
