      ...
      <div class="result-box">
        <div class="btn-box cus-mb-10">
          <el-button
            ...
            @click="$router.push('/medicalSocialSecurity/addSocialSecurity')"
          >新增</el-button>
        ...
        <el-table :data="tableData" border class="cus-mb-20">
          ...
          <el-table-column prop="isHandle" label="是否办理手续" width="130px"></el-table-column>
          <el-table-column prop="handleDate" label="办理日期" width="130px"></el-table-column>
