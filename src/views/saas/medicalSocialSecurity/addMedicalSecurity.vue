    ...
    <div class="content-box">
      <el-form ref="form" label-width="110px" :rules="rules">
        <el-collapse v-model="activeNames">
          ...
          <el-collapse-item title="医保信息" name="2">
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item label="医保账号" prop="account">
              ...
              <el-col :span="8">
                <el-form-item label="参保属性" prop="canbaoAttibute">
                  <el-select v-model="landConfirmDialogForm.isFarmland" placeholder="请选择">
                    <el-option
                      v-for="item in canbaoAtrribute"
                      :key="item.value"
                      :label="item.label"
                      :value="item.value"
                    ></el-option>
              ...
              <el-col :span="8">
                <el-form-item label="医保类型" prop="type">
                  <el-select v-model="landConfirmDialogForm.isFarmland" placeholder="请选择">
                    <el-option
                      v-for="item in type"
                      :key="item.value"
                ...
                <el-form-item label="票据号码" prop="number">
                  <el-input placeholder="请输入"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        number: [{ required: true, message: '请输入11', trigger: 'blur' }]
      },
      gridData: [
        {
          name: '张三',
