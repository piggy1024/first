  ...
  <div class="app-container">
    ...
    <div class="result-box">
      ...
      <el-table :data="dataList" border class="cus-mb-20">
        ...
        <el-table-column prop="illegalAct" label="违法行为" min-width="120"></el-table-column>
    ...
    >
      <el-form label-width="90px" :model="modifyForm">
        <el-form-item label="违法行为" prop="illegalAct">
          <el-input type="textarea" v-model="modifyForm.illegalAct" style="width:400px"></el-input>
        </el-form-item>
...
<script>
// api
import criminalRecordPersonService from '@/api/comprehensiveControl/CriminalRecordPersonService'
...
export default {
  ...
  methods: {
    fetchTableDataListPromise(entity) {
      return criminalRecordPersonService.listCriminalRecordPerson(entity)
    },
    HandleModify(row) {
      // console.log(row);
      // debugger
    ...
    modifyDialogPromise(entity) {
      return criminalRecordPersonService.updateCriminalRecordPerson(entity)
    }
  }
}
</script>
