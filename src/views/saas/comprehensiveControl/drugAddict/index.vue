  ...
  <div class="app-container">
    ...
    <div class="result-box">
      ...
      <el-table :data="dataList" border class="cus-mb-20">
        ...
        <el-table-column prop="realitySituation" label="现实状况" min-width="120"></el-table-column>
...
<script>
import drugAddictService from '@/api/comprehensiveControl/DrugAddictService'
...
export default {
  ...
  methods: {
    fetchTableDataListPromise(entity) {
      return drugAddictService.listDrugAddict(entity)
    },
    HandleModify(row) {
      // console.log(row);
      this.modifyForm = {
    ...
    modifyDialogPromise(entity) {
      return drugAddictService.updateDrugAddict(entity)
    }
  }
}
</script>
