  ...
  <div class="app-container">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                ...
                <el-form-item label="财政代码">
                  <el-input v-model="advanceQueryParams.financialCode" placeholder="支持模糊搜索"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="救助年份">
                  <el-date-picker
                    v-model="advanceQueryParams.year"
                    type="year"
                    value-format="yyyy"
                    placeholder="请选择"
                  ></el-date-picker>
    ...
    <div class="result-box">
      ...
      <el-table :data="dataList" border class="cus-mb-20">
        ...
        <el-table-column prop="bankAccountNumber" label="银行账号" width="100"></el-table-column>
        <el-table-column prop="startTime" label="开始时间" width="100"></el-table-column>
        <el-table-column prop="endTime" label="取消时间" width="100"></el-table-column>
        <el-table-column prop="person.phoneNumber" label="联系电话" width="100"></el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="210">
          <template>
            <el-button
              ...
              icon="el-icon-edit"
              size="mini"
              @click="$router.push('/civilAffairs/tempSuccourObjectEdit')"
            >编辑</el-button>
...
// api
import tempSuccourObjectService from '@/api/civilAffairs/TempSuccourObjectService'
...
export default {
  ...
  methods: {
    fetchTableDataListPromise(entity) {
      return tempSuccourObjectService.listTempSuccourObject(entity)
    },
    getFastEntity() {
      return {
