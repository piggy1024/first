  ...
  <div class="app-container">
    ...
    <div class="result-box">
      ...
      <el-table :data="dataList" border class="cus-mb-20">
        ...
        <el-table-column prop="person.nthnic" label="民族"></el-table-column>
        <el-table-column prop="person.sex" label="性别"></el-table-column>
        <el-table-column prop="person.idCardNumber" label="身份证号" width="150px"></el-table-column>
        <el-table-column prop="diffType" label="多重类型"></el-table-column>
        <el-table-column prop="financialCode" label="财政代码" width="100px"></el-table-column>
        <el-table-column prop="bankAccountNumber" label="银行账号" width="100px"></el-table-column>
        ...
        <el-table-column prop="person.phoneNumber" label="联系电话" width="100px"></el-table-column>
        <el-table-column prop="currentResideAddress" label="地址" width="200px"></el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="90">
          <template>
            <el-button
              ...
              icon="el-icon-edit"
              size="mini"
              @click="$router.push('/civilAffairs/retrenchObjectEdit')"
            >编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
...
// api
import retrenchObjectService from '@/api/civilAffairs/RetrenchObjectService'
...
export default {
  ...
  data() {
    return {
      ...
      isHeightLevel: false, fastQueryParams: {
        // 快速搜索参数
        name: ''
      },
      advanceQueryParams: {
  ...
  methods: {
    fetchTableDataListPromise(entity) {
      return retrenchObjectService.listRetrenchObject(entity)
    },
    getFastEntity() {
      return {
