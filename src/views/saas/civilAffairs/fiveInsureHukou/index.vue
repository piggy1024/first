  ...
  <div class="app-container">
    ...
    <div class="result-box">
      ...
      <el-table :data="tableData" border class="cus-mb-20">
        ...
        <el-table-column prop="supportType" label="供养类别"></el-table-column>
        <el-table-column prop="hostNumber" label="户数"></el-table-column>
        <el-table-column prop="diffType" label="多重类型"></el-table-column>
        <el-table-column prop="disCount" label="其中残疾人小计" width="150px"></el-table-column>
        <el-table-column prop="dis" label="残疾人(不含老年人)" width="150px"></el-table-column>
        <el-table-column prop="oldCount" label="老年人小计" width="100px"></el-table-column>
        <el-table-column prop="oldDis" label="其中老年残疾人" width="150px"></el-table-column>
        <el-table-column prop="allSelf" label="全自理"></el-table-column>
        <el-table-column prop="halfNursing" label="半护理"></el-table-column>
        <el-table-column prop="totalNursing" label="全护理"></el-table-column>
        <el-table-column prop="supportNumber" label="供养证号" width="100px"></el-table-column>
        <el-table-column prop="disLevel" label="残疾等级"></el-table-column>
        <el-table-column prop="disNumber" label="残疾证号"></el-table-column>
        <el-table-column prop="financeCode" label="财政代码"></el-table-column>
        <el-table-column prop="bankName" label="银行账户名" width="100px"></el-table-column>
        ...
        <el-table-column prop="houseStituation" label="住房情况"></el-table-column>
        <el-table-column prop="accountType" label="户口性质"></el-table-column>
        ...
        <el-table-column fixed="right" label="操作" width="210">
          <template>
            <el-button
              ...
              icon="el-icon-edit"
              size="mini"
              @click="$router.push('/civilAffairs/fiveInsureHukouEditt')"
            >编辑</el-button>
            <el-button
              type="primary"
              icon="el-icon-printer"
