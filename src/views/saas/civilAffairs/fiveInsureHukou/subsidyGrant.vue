    ...
    <div class="right-container">
      ...
      <div class="result-box">
        ...
        <el-table :data="tableData" border class="cus-mb-20">
          ...
          <el-table-column prop="joinTime" label="入伍时间" width="100px"></el-table-column>
          <el-table-column prop="retireTime" label="退伍时间" width="100px"></el-table-column>
          <el-table-column prop="bankAccount" label="银行卡账号" width="150px"></el-table-column>
