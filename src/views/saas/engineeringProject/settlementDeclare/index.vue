    ...
    <div class="result-box">
      <div class="btn-box cus-mb-10">
        <el-button
          ...
          @click="$router.push('/engineeringProject/addSettlementDeclare')"
        >新增</el-button>
      ...
      <el-table :data="tableData" border class="cus-mb-20">
        ...
        <el-table-column prop="finalAmount" label="决算金额" width="100"></el-table-column>
        <el-table-column prop="tatalAmount" label="累计结算金额" width="110"></el-table-column>
        ...
        <el-table-column label="操作" fixed="right" width="220">
          <template>
            <el-button
              type="primary"
              size="mini"
              @click="$router.push('/engineeringProject/detailSettlementDeclare')"
            >详情</el-button>
            <el-button
              type="primary"
              size="mini"
