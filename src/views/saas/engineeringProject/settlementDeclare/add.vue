    ...
    <div class="content-box">
      <el-collapse v-model="activeNames">
        ...
        <el-form ref="form" label-width="110px" :rules="rules" class="cus-pr-15">
          ...
          <el-collapse-item title="决算信息" name="2">
            <template slot="title">
              <span>决算信息</span>
              <p class="total-money cus-text-red">决算合计：1000 元</p>
            </template>
            <!-- <div class="cus-mb-10">
              <el-button
                type="primary"
            ...
            <el-table :data="budgetInfo" border>
              <el-table-column prop="temp1" label="决算构成" min-width="160"></el-table-column>
          ...
          <el-collapse-item title="结算信息" name="4">
            ...
            <el-table :data="billingInfo" border>
              <el-table-column prop="temp1" label="报账日期">
                <template slot-scope="scope">
                  <el-date-picker v-model="scope.row.temp1" type="date" placeholder="选择日期"></el-date-picker>
                </template>
              </el-table-column>
              <el-table-column prop="temp2" label="转账金额">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.temp2"></el-input>
                </template>
              </el-table-column>
              <el-table-column prop="temp3" label="预付款金额">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.temp3"></el-input>
                </template>
              </el-table-column>
              <el-table-column prop="temp4" label="领款人">
                <template slot-scope="scope">
                  <el-input readonly v-model="scope.row.temp4"></el-input>
                </template>
              </el-table-column>
              <el-table-column prop="temp4" label="备注">
                <template slot-scope="scope">
                  <el-input readonly v-model="scope.row.temp5"></el-input>
                </template>
              </el-table-column>
              <el-table-column label="操作" width="150">
                <template>
