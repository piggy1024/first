  ...
  <div class="app-container">
    ...
    <div class="result-box">
      ...
      <el-table
        ...
        <el-table-column prop="villager.birthDate" label="出生日期" width="120">
          <template slot-scope="scope">
            {{scope.row.villager.birthDate | parseTime('{y}-{m}-{d}')}}
          </template>
        </el-table-column>
        <el-table-column prop="villager.hshdRgstAddress" label="户籍地址" min-width="120"></el-table-column>
        <el-table-column prop="villager.registerHouseholdDate" label="入户日期" width="120">
          <template slot-scope="scope">
            {{scope.row.villager.registerHouseholdDate | parseTime('{y}-{m}-{d}')}}
          </template>
        </el-table-column>
  ...
  methods: {
    ...
    getFastEntity() {
      return {
        ...
        populationAndFpType: '03' // 新生儿类型：03
      }
    },
    getAdvanceEntity() {
      return {
