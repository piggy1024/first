  ...
  <div class="app-container">
    ...
    <div class="result-box">
      ...
      <el-table v-loading="dataListLoading" :data="dataList" ref="dataListTable" border class="cus-mb-20">
        ...
        <el-table-column prop="villager.currentResideAddress" label="现居住地址" min-width="120"></el-table-column>
        <el-table-column prop="villager.origHshdRgstAddress" label="原居住地址" min-width="120"></el-table-column>
        <el-table-column prop="person.phoneNumber" label="联系电话" width="120"></el-table-column>
        <el-table-column prop="villager.status" :formatter="formatColumn('villager.status', 'status')" label="状态" width="120"></el-table-column>
        <el-table-column prop="huoseholdMain" label="户主" width="120"></el-table-column>
        <el-table-column prop="populationAndFp.remark" label="备注" width="120"></el-table-column>
        <el-table-column label="操作" fixed="right" width="80">
          ...
          <template slot-scope="scope">
            <el-button
              type="primary"
              size="mini"
              @click="$router.push('/populationAndFP/tempResidePersonModify/' + scope.row.villagerId)"
            >修改</el-button>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  created() {
    this.getSelectOptions(['sex', 'status'])
  },
  methods: {
    fetchTableDataListPromise(entity) {
      return TempResidePersonService.listTempResidePerson(entity)
    },
    getFastEntity() {
      return {}
    },
    getAdvanceEntity() {
      return {
        ...
        populationAndFpType: '01' // 暂住人员类型：02
      }
    }
  }
}
